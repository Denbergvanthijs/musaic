...
from smt22.models import build_model, build_simple_model, build_simpler_model
...
if __name__ == "__main__":
    ...
    model_rhythm.compile(optimizer=opt_rhythm, loss="binary_crossentropy", metrics="categorical_accuracy")
    model_melody.compile(optimizer=opt_melody, loss="binary_crossentropy", metrics="categorical_accuracy")
